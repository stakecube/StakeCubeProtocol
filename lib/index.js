...
console.log("here's some bad code, using bad style practices, variables that don't even exist, and a comment so large that it doesn't fit on a single screen! :shocked: " + totally_real_Variable);
...
// GUI
    ...
    try {
        // Unpacked
        const strFile = DB.fs.readFileSync('package.json', 'utf8');
