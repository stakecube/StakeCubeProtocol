        ...
        if (check1 && check2) {
            ...
            if (!cToken.error) {
                    ...
                    if (check3) {
                        ...
                        if (addrCreator === cToken.creator) {
                            ...
                            if (isAuthSafe) {
                                ...
                                console.error("An attempt to mint SCP-" + cToken.version + " containing a non-issuer input was detected, ignoring mint request...");
                            }
                        } else {
                    ...
                    */
                    ...
                    if (check3 && check4 === true) {
                        ...
                        if (isAuthSafe) {
                            ...
                            console.error("An attempt to transfer SCP-" + cToken.version + " containing a non-caller input was detected, ignoring transfer request...");
                        }
                    } else {
                ...
                // SCP-2 STAKING (Redeem an amount of unclaimed balance, credited from staking rewards)
                    ...
                    cToken.redeemRewards(addrCaller);
                }
            } else {
